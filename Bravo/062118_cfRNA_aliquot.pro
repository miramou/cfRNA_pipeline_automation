...
<Velocity11 file='Protocol_Data' md5sum='20a82dd4f8a7959d10f74d51004a1b2f' version='2.0' >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Place random hexamer prepped plate at pos 6
